...
This is a fork of [grunt-ng-annotate](https://github.com/mgol/grunt-ng-annotate) that replaces the deprecated [ng-annotate](https://github.com/olov/ng-annotate) dependency with the patched version: [ng-annotate-patched](https://github.com/bluetech/ng-annotate-patched).

[![Build Status](https://travis-ci.org/wjentner/grunt-ng-annotate-patched.svg?branch=master)](https://travis-ci.org/wjentner/grunt-ng-annotate-patched)

## Original readme of grunt-ng-annotate
